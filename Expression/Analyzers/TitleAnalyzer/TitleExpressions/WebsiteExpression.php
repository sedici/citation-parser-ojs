...
include_once('GenericExpression.php');
    ...
    class WebsiteExpression extends GenericExpression{
        ...
        /**
         * Get the pattern of the expression
         * @return array
         * 
         * e.g:
         * - Observatorio de la Seguridad Social. (s.f.). ANSES. Recuperado el 7 de marzo de 2024 de https://www.anses.gob.ar/observatorio/
         * - Observatorio de la Seguridad Social. (s.f.). ANSES. Instituto Cultural de la Provincia de Buenos Aires. (s.f). Museos. Gobierno de la Provincia de Buenos Aires. https://www.gba.gob.ar/cultura/museos
         */
